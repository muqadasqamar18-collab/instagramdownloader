    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <div className="flex w-full max-w-xl flex-col items-center gap-2 text-sm sm:flex-row sm:justify-center sm:gap-6">
            <div className="flex items-center gap-2">
              <Check className="h-4 w-4 text-[color:var(--ig-pink)]" />
              <span className="text-muted-foreground">{t("bullets.supported")}</span>
            </div>
            <div className="flex items-center gap-2">
              <Check className="h-4 w-4 text-[color:var(--ig-pink)]" />
              <span className="text-muted-foreground">{t("bullets.trust")}</span>
            </div>
          </div>
          <div className="mt-8">
            <a href={homeLinks.howItWorks}>
              ...
              <ArrowDown className="mx-auto h-6 w-6 animate-bounce text-[color:var(--ig-pink)]" />
            </a>
          </div>
        </div>
      </div>
