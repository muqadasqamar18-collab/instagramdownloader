  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-white backdrop-blur supports-[backdrop-filter]:bg-gray-50/60 dark:bg-gray-900/80">
      <div className="container mx-auto flex h-16 items-center px-4">
        ...
        >
          <LogoImage className="h-6 w-6 text-[color:var(--ig-pink)]" />
          <LogoText className="ig-gradient-text font-semibold" />
        </div>
        ...
        <nav className="ml-auto hidden items-center gap-6 md:flex">
          <a
            ...
            className="text-sm font-medium transition-colors hover:text-[color:var(--ig-pink)]"
          >
            {t("links.features")}
          </a>
          <a
            ...
            >
              ...
              <div className="flex h-full flex-col">
                <nav className="flex flex-col gap-4 px-4">
                  <a
                    href={homeLinks.features}
                    className="px-2 py-2 text-lg font-medium transition-colors hover:text-[color:var(--ig-pink)]"
