      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-8 text-center">
          <div className="space-y-2">
            <div className="ig-badge mb-2 inline-block rounded-lg px-3 py-1 text-sm">
              {t("badge")}
            </div>
          ...
          <div className="relative mx-auto mt-12 hidden w-full max-w-4xl md:block">
            <div className="grid grid-cols-3 gap-4">
              <div className="relative flex flex-col items-center space-y-4">
                <div className="ig-gradient-bg z-10 flex h-16 w-16 items-center justify-center rounded-full text-xl font-bold text-white shadow-lg">
                  1
                </div>
                <div className="h-full rounded-xl border border-gray-100 bg-white p-6 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                  <div className="mb-4 flex justify-center">
                    <Copy className="h-8 w-8 text-[color:var(--ig-pink)]" />
                  </div>
              ...
              <div className="relative flex flex-col items-center space-y-4">
                ...
                <div className="h-full rounded-xl border border-gray-100 bg-white p-6 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                  <div className="mb-4 flex justify-center">
                    <Clipboard className="h-8 w-8 text-[color:var(--ig-pink)]" />
                  </div>
                  <h3 className="mb-2 text-xl font-bold">
                    {t("steps.paste.title")}
                  </h3>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div className="h-full rounded-xl border border-gray-100 bg-white p-6 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                  <div className="mb-4 flex justify-center">
                    <Download className="h-8 w-8 text-[color:var(--ig-pink)]" />
                  </div>
                  <h3 className="mb-2 text-xl font-bold">
          ...
          <div className="relative mx-auto w-full max-w-sm space-y-8 md:hidden">
            ...
            <div className="absolute top-0 bottom-16 left-4 w-0.5 bg-[color:color-mix(in_srgb,var(--ig-pink)_25%,transparent)]"></div>

            <div className="relative flex items-start space-x-6">
              <div className="ig-gradient-bg z-10 flex h-8 w-8 shrink-0 items-center justify-center rounded-full font-bold text-white">
                1
              </div>
              <div className="flex-1 rounded-lg border border-gray-100 bg-white p-4 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                <div className="mb-2 flex items-center">
                  <Copy className="mr-2 h-5 w-5 text-[color:var(--ig-pink)]" />
            ...
            <div className="relative flex items-start space-x-6">
              ...
              <div className="flex-1 rounded-lg border border-gray-100 bg-white p-4 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                <div className="mb-2 flex items-center">
                  <Clipboard className="mr-2 h-5 w-5 text-[color:var(--ig-pink)]" />
            ...
            <div className="relative flex items-start space-x-6">
              ...
              <div className="flex-1 rounded-lg border border-gray-100 bg-white p-4 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
                <div className="mb-2 flex items-center">
                  <Download className="mr-2 h-5 w-5 text-[color:var(--ig-pink)]" />
                  <h3 className="text-lg font-bold">
                    {t("steps.download.title")}
                  </h3>
                </div>
