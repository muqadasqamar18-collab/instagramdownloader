          ...
          <div className="mx-auto grid w-full max-w-3xl grid-cols-1 gap-6">
            ...
            <div className="rounded-xl border border-gray-50 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <h3 className="mb-4 flex items-center text-xl font-bold">
                <div className="ig-icon-ring mr-3 rounded-full p-2">
                  <svg
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1" className="border-b">
                  <AccordionTrigger className="py-4 text-left font-medium hover:text-[color:var(--ig-pink)] hover:no-underline">
                ...
                <AccordionItem value="item-4" className="border-b">
                  <AccordionTrigger className="py-4 text-left font-medium hover:text-[color:var(--ig-pink)] hover:no-underline">
                    {t("sections.general.q4.trigger")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-4 text-start">
                    {t("sections.general.q4.content")}
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
            ...
            <div className="rounded-xl border border-gray-50 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-7" className="border-b">
                  <AccordionTrigger className="py-4 text-left font-medium hover:text-[color:var(--ig-pink)] hover:no-underline">
                    {t("sections.technical.q3.trigger")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-4 text-start">
                    {t("sections.technical.q3.content")}
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-8" className="border-b">
                  <AccordionTrigger className="py-4 text-left font-medium hover:text-[color:var(--ig-pink)] hover:no-underline">
                    {t("sections.technical.q4.trigger")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-4 text-start">
                    {t("sections.technical.q4.content")}
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-9" className="border-b">
                  <AccordionTrigger className="py-4 text-left font-medium hover:text-[color:var(--ig-pink)] hover:no-underline">
                    {t("sections.technical.q5.trigger")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-4 text-start">
                    {t("sections.technical.q5.content")}
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-10" className="border-b">
                  <AccordionTrigger className="py-4 text-left font-medium hover:text-[color:var(--ig-pink)] hover:no-underline">
                    {t("sections.technical.q6.trigger")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-4 text-start">
                    {t("sections.technical.q6.content")}
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
